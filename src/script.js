...
function formatDangerText(text) {
	return String(text || '')
		...
		.replace(/(Pelagic Groupers?)([,.]?)/gi, (_, name, punctuation) => `<a class="enemy-name enemy-tooltip tip-marked tip-marked--enemy" href="${enemyWikiLinks['Pelagic Grouper']}" target="_blank" rel="noopener noreferrer" style="--enemy-tooltip-image: url('img/enemies/Pelagic_Grouper.webp')"><span class="tip-marked-text">${name}</span><span class="tip-marked-icon" aria-hidden="true"></span></a>${punctuation}`)
		.replace(/(Pelagic Shamans?)([,.]?)/gi, (_, name, punctuation) => `<a class="enemy-name enemy-tooltip tip-marked tip-marked--enemy" href="${enemyWikiLinks['Pelagic Shaman']}" target="_blank" rel="noopener noreferrer" style="--enemy-tooltip-image: url('img/enemies/Pelagic_Shaman.webp')"><span class="tip-marked-text">${name}</span><span class="tip-marked-icon" aria-hidden="true"></span></a>${punctuation}`)
		.replace(/(Pelagic Guardians?)([,.]?)/gi, (_, name, punctuation) => `<a class="enemy-name enemy-tooltip tip-marked tip-marked--enemy" href="${enemyWikiLinks['Pelagic Guardian']}" target="_blank" rel="noopener noreferrer" style="--enemy-tooltip-image: url('img/enemies/Pelagic_Guardian_Defend.webp')"><span class="tip-marked-text">${name}</span><span class="tip-marked-icon" aria-hidden="true"></span></a>${punctuation}`)
